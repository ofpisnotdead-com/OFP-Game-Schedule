...
if ($lang["THIS_CODE"] == "en-US") {
	$lang = array_merge($lang, array(
		...
		"GS_API_OVERVIEW" => "To get information in JSON format about the servers and mods on the website send a request to the <a href=\"%m1%\">%m1%</a> with the following arguments:",
...
if ($lang["THIS_CODE"] == "ru-RU") {
	$lang = array_merge($lang, array(
		...
		"GS_API_OVERVIEW" => "Чтобы получить информацию о серверах и модах на сайте в формате JSON, напишите запрос по ссылке <a href=\"%m1%\">%m1%</a> со следующими пунктами:",
